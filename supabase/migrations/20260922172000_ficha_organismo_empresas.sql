-- ============================================================
-- Ficha de organismo: cuántas empresas le han vendido, sin tope
-- ============================================================
--
-- Aplicada el 22/09/2026. La cabecera de la ficha decía "20 empresas"
-- en cualquier organismo grande: contaba la lista de empresas, que se
-- corta en 20. Ahora la cifra es el recuento real del periodo.
-- ============================================================
